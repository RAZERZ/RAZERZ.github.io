...
function pgProjects(el) {
    ...
    createProjList(personalSelectEl,22, 1, "<br>Ticketing system for a local computer store. Eased their workflow and enabled backups.");
    createProjList(personalSelectEl,18, 1, "<br>Installation script for pwnpi that simplified the installation process. The community found the installation process complicated.");
    createProjList(personalSelectEl,17, 1, "<br>Pulls flight data form flightaware for use with phpVMS. This project was done for the flight simulation community, who found it very useful.");
