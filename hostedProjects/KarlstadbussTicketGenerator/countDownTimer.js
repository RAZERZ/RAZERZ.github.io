...
var validTime = (date.getHours()<10?'0':'') + date.getHours() + ":" + (((parseInt(date.getMinutes())-1)<10?'0':'') + (parseInt(date.getMinutes()) -1));
var endTime = (((parseInt(date.getHours())+1)<10?'0':'') + (parseInt(date.getHours()) +1)) + ":" + (((parseInt(date.getMinutes())-1)<10?'0':'') + (parseInt(date.getMinutes()) -1));
