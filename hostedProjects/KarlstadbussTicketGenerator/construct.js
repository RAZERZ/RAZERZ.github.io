window.onload = function() {
    ...
    if(isInWebAppiOS === false && isInWebAppChrome === false) {
        ...
        createModal('<div style="background: #282828; padding: 10%; "><p style="font-size: 6em; font-weight: bolder; margin: unset; text-align: center;">Villkor</p></div><div style="font-size: 3em; padding: 10%;"><p>By continuing, you are hereby solely responsible for any consequences when using this online site. <p>I take no responsibility whatsoever. This shall only be used for development and or learning purposes. </p><p>Made by Rami Abou Zahra, All rights reserved.</p></p></div><button class="acceptBtn" onclick="closeModal(this)">ACCEPT</button></div>');
    }
